...
public class BinaryTreeExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("搜尋 1: " + search(root, 1));     // true
        System.out.println("搜尋 2: " + search(root, 2));     // true
        System.out.println("搜尋 3: " + search(root, 3));     // true
        System.out.println("搜尋 5: " + search(root, 5));     // true
        System.out.println("搜尋 7: " + search(root, 7));     // false
        System.out.println("搜尋 0: " + search(root, 0));     // false
    }
}
